...
func (x *UpdateRequest) GetPosition() Postiton {
	if x != nil {
		return x.Position
	}
...
type SaveRequest struct {
	...
	Position Postiton `protobuf:"varint,2,opt,name=position,proto3,enum=players.Postiton" json:"position,omitempty"`
...
func (x *SaveRequest) GetPosition() Postiton {
	if x != nil {
		return x.Position
	}
	return Postiton_DEFAULT
...
var file_proto_players_proto_rawDesc = []byte{
	...
	0x2e, 0x50, 0x6f, 0x73, 0x74, 0x69, 0x74, 0x6f, 0x6e, 0x52, 0x08, 0x70, 0x6f, 0x73, 0x69, 0x74,
	...
	0x74, 0x69, 0x74, 0x6f, 0x6e, 0x52, 0x08, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x12,
	...
	0x2e, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x73, 0x2e, 0x50, 0x6f, 0x73, 0x74, 0x69, 0x74, 0x6f,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2a, 0x40, 0x0a, 0x08, 0x50, 0x6f, 0x73, 0x74,
	0x69, 0x74, 0x6f, 0x6e, 0x12, 0x0b, 0x0a, 0x07, 0x44, 0x45, 0x46, 0x41, 0x55, 0x4c, 0x54, 0x10,
...
var file_proto_players_proto_depIdxs = []int32{
	0,  // 0: players.UpdateRequest.position:type_name -> players.Postiton
	6,  // 1: players.UpdateResponse.player:type_name -> players.Player
	0,  // 2: players.SaveRequest.position:type_name -> players.Postiton
	0,  // 3: players.Player.position:type_name -> players.Postiton
